      ...
      {apiKeys.length === 0 ? (
        ...
        <div className="space-y-3">
          {apiKeys.map((apiKey: APIKey) => (
            <Card key={apiKey.id} className="border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 hover:shadow-sm dark:hover:shadow-gray-900/20 transition-all duration-200">
                    ...
                    <div className="flex items-center gap-2 mb-1">
                        ...
                        <Badge 
                          ...
                          className={apiKey.is_active ?
                            "text-xs px-1.5 py-0 bg-orange-50 text-orange-700 border-orange-200 dark:bg-orange-900/20 dark:text-orange-300 dark:border-orange-800" :
                            "text-xs px-1.5 py-0 bg-gray-50 text-gray-600 border-neutral-200 dark:bg-neutral-800 dark:text-gray-400 dark:border-neutral-700"
                          }
                        >
                      ...
                      {apiKey.full_key && (
                        <div className="flex items-center gap-2 mb-2 p-2 bg-gray-50 dark:bg-neutral-800 rounded border">
                          <Input
                      ...
                      <Tooltip>
                        <TooltipTrigger asChild>
                          <Button
                            ...
                            className="h-7 px-2 text-gray-500 dark:text-gray-400 hover:text-orange-600 hover:bg-orange-50 dark:hover:bg-orange-900/20 dark:hover:text-orange-400"
                          >
            ...
            <div className="py-4">
              <div className="relative">
                <Input
                  ...
                  readOnly
                  className="font-mono text-xs h-9 pr-16 bg-gray-50 dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700 text-gray-900 dark:text-gray-100"
                />
        ...
        <DialogContent className="sm:max-w-md bg-white dark:bg-neutral-900 border-neutral-200 dark:border-neutral-800">
          ...
          <DialogFooter>
            <Button 
              ...
              className="h-8 px-3 text-xs border-neutral-200 dark:border-neutral-700 text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-800"
            >
              Cancel
            </Button>
            <Button
