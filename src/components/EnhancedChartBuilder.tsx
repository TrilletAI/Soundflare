  ...
  if (fieldsLoading) {
    return (
      <div className="space-y-6">
        <Card className="border-0 bg-gradient-to-r from-orange-50 to-purple-50">
    ...
    <div className="space-y-6">
      ...
      {charts.length > 0 ? (
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
          {charts.map(chart => (
            <Card key={chart.id} className="border border-neutral-300 bg-white shadow-sm hover:shadow-md transition-shadow">
          ...
          <Card className="border border-dashed border-neutral-300 bg-white hover:shadow-md transition-shadow flex items-center justify-center p-8">
