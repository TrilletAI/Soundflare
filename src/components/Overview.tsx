...
const COLOR_CLASSES = {
  blue: 'bg-blue-100 dark:bg-orange-900/20 text-blue-600 dark:text-orange-400',
    ...
    <div className={`grid gap-3 ${isMobile ? 'grid-cols-2' : 'grid-cols-6 gap-4'}`}>
      {Array.from({ length: getVisibleCardCount() }).map((_, index) => (
        <div key={index} className="group">
          <div className="bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-xl shadow-sm">
            <div className={isMobile ? 'p-3' : 'p-5'}>
              <div className={`flex items-start justify-between ${isMobile ? 'mb-2' : 'mb-4'}`}>
                <div className={`${isMobile ? 'w-7 h-7' : 'w-9 h-9'} bg-gray-100 dark:bg-neutral-700 rounded-lg animate-pulse`}></div>
                <div className={`${isMobile ? 'w-8 h-4' : 'w-12 h-5'} bg-gray-100 dark:bg-neutral-700 rounded animate-pulse`}></div>
              </div>
              <div className="space-y-1">
                <div className={`${isMobile ? 'h-2 w-16' : 'h-3 w-20'} bg-gray-200 dark:bg-neutral-600 animate-pulse rounded`}></div>
                <div className={`${isMobile ? 'h-6 w-12' : 'h-8 w-16'} bg-gray-200 dark:bg-neutral-600 animate-pulse rounded`}></div>
                <div className={`${isMobile ? 'h-2 w-12' : 'h-3 w-16'} bg-gray-100 dark:bg-neutral-700 animate-pulse rounded`}></div>
              </div>
            </div>
          </div>
        </div>
  ...
  return (
    <div className={`grid gap-4 ${isMobile ? 'grid-cols-1' : 'grid-cols-2 gap-6'}`}>
      {Array.from({ length: 4 }).map((_, index) => (
        <div key={index} className="bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-xl shadow-sm">
          <div className={`border-b border-neutral-200 dark:border-neutral-700 ${isMobile ? 'px-4 py-4' : 'px-7 py-6'}`}>
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-3">
                <div className={`${isMobile ? 'w-7 h-7' : 'w-9 h-9'} bg-gray-100 dark:bg-neutral-700 rounded-lg animate-pulse`}></div>
                <div>
                  <div className={`${isMobile ? 'h-4 w-24 mb-1' : 'h-5 w-32 mb-2'} bg-gray-200 dark:bg-neutral-600 animate-pulse rounded`}></div>
                  <div className={`${isMobile ? 'h-3 w-32' : 'h-4 w-48'} bg-gray-100 dark:bg-neutral-700 animate-pulse rounded`}></div>
                </div>
              </div>
              <div className="text-right">
                <div className={`${isMobile ? 'h-3 w-8 mb-1' : 'h-4 w-12 mb-1'} bg-gray-100 dark:bg-neutral-700 animate-pulse rounded`}></div>
                <div className={`${isMobile ? 'h-4 w-6' : 'h-5 w-8'} bg-gray-200 dark:bg-neutral-600 animate-pulse rounded`}></div>
              </div>
            </div>
          </div>
          <div className={isMobile ? 'p-4' : 'p-7'}>
            <div className={`${isMobile ? 'h-48' : 'h-80'} bg-gray-50 dark:bg-neutral-800 rounded-lg animate-pulse flex items-center justify-center`}>
...
const Overview: React.FC<OverviewProps> = ({ 
  ...
  const loadCustomTotals = useCallback(async () => {
  ...
  }, [role, roleLoading, parentLoading, loadCustomTotals])
  ...
  if (parentLoading || roleLoading || analyticsLoading) {
    return (
      <div className="h-full bg-gray-50 dark:bg-neutral-900">
        ...
        <div className={isMobile ? 'p-4' : 'p-8'}>
          <div className="flex items-center justify-center py-20">
            <div className="text-center space-y-6 max-w-sm">
              <div className={`${isMobile ? 'w-12 h-12' : 'w-16 h-16'} bg-white dark:bg-neutral-800 rounded-2xl border border-red-200 dark:border-red-800 flex items-center justify-center mx-auto shadow-sm`}>
        ...
        <div className={isMobile ? 'p-4' : 'p-8'}>
          <div className="h-full flex items-center justify-center">
            <div className="text-center space-y-8">
              <div className={`${isMobile ? 'w-16 h-16' : 'w-20 h-20'} bg-white dark:bg-neutral-800 rounded-2xl border border-neutral-200 dark:border-neutral-700 flex items-center justify-center mx-auto shadow-sm`}>
    ...
    <div className="h-full bg-gray-50 dark:bg-neutral-900">
      <div className={`space-y-6 ${isMobile ? 'p-4' : 'p-8 space-y-8'}`}>
        ...
        <div className={`grid gap-3 ${isMobile ? 'grid-cols-2' : 'grid-cols-6 gap-4'}`}>
          {/* Total Calls */}
          <div className="group">
            <div className="bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-xl shadow-sm hover:shadow-md hover:border-neutral-400 dark:hover:border-neutral-600 transition-all duration-300">
              <div className={isMobile ? 'p-3' : 'p-5'}>
                <div className={`flex items-start justify-between ${isMobile ? 'mb-2' : 'mb-4'}`}>
                  <div className={`p-2 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-100 dark:border-orange-800`}>
                    <Phone weight="regular" className={`${isMobile ? 'w-4 h-4' : 'w-5 h-5'} text-orange-600 dark:text-orange-400`} />
                  </div>
                </div>
                <div className="space-y-1">
            ...
            <div className="bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-xl shadow-sm hover:shadow-md hover:border-neutral-400 dark:hover:border-neutral-600 transition-all duration-300">
              <div className={isMobile ? 'p-3' : 'p-5'}>
                <div className={`flex items-start justify-between ${isMobile ? 'mb-2' : 'mb-4'}`}>
                  ...
                  {!isMobile && (
                    <div className="text-right">
                      <span className="text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-neutral-700 px-2 py-1 rounded-md">
              ...
              <div className="bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-xl shadow-sm hover:shadow-md hover:border-neutral-400 dark:hover:border-neutral-600 transition-all duration-300">
                <div className={isMobile ? 'p-3' : 'p-5'}>
                  <div className={`flex items-start justify-between ${isMobile ? 'mb-2' : 'mb-4'}`}>
                    ...
                    {!isMobile && (
                      <div className="text-right">
                        <span className="text-xs font-medium text-gray-500 dark:text-gray-400">USD</span>
                      </div>
                    )}
                  </div>
                  <div className="space-y-1">
              ...
              <div className="bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-xl shadow-sm hover:shadow-md hover:border-neutral-400 dark:hover:border-neutral-600 transition-all duration-300">
                <div className={isMobile ? 'p-3' : 'p-5'}>
                  <div className={`flex items-start justify-between ${isMobile ? 'mb-2' : 'mb-4'}`}>
                    ...
                    {!isMobile && (
                      <div className="text-right">
                        <span className="text-xs font-medium text-gray-500 dark:text-gray-400 bg-gray-100 dark:bg-neutral-700 px-2 py-1 rounded-md">avg</span>
                      </div>
                    )}
                  </div>
                  <div className="space-y-1">
                    ...
                    <div className={`flex items-start justify-between ${isMobile ? 'mb-2' : 'mb-4'}`}>
                      ...
                      <div className={`flex items-center gap-1 ${isMobile ? 'opacity-100' : 'opacity-0 group-hover:opacity-100'} transition-opacity`}>
                        <Button
                          variant="ghost"
                          size="sm"
                          className={`${isMobile ? 'h-5 w-5' : 'h-6 w-6'} p-0 hover:bg-gray-100 dark:hover:bg-neutral-700`}
        ...
        <div className={`grid gap-4 ${isMobile ? 'grid-cols-1' : 'grid-cols-2 gap-6'}`}>
          {/* Daily Calls Chart */}
          <div className="bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
            <div className={`border-b border-neutral-200 dark:border-neutral-700 ${isMobile ? 'px-4 py-4' : 'px-7 py-6'}`}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className={`p-2 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-100 dark:border-orange-800`}>
                    <TrendUp weight="regular" className={`${isMobile ? 'w-4 h-4' : 'w-5 h-5'} text-orange-600 dark:text-orange-400`} />
                  </div>
                  <div>
          ...
          <div className="bg-white dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700 rounded-xl shadow-sm hover:shadow-md transition-all duration-300">
            <div className={`border-b border-neutral-200 dark:border-neutral-700 ${isMobile ? 'px-4 py-4' : 'px-7 py-6'}`}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className={`p-2 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-100 dark:border-orange-800`}>
                    <ChartBar weight="regular" className={`${isMobile ? 'w-4 h-4' : 'w-5 h-5'} text-orange-600 dark:text-orange-400`} />
                  </div>
                  <div>
          ...
          <div className="bg-white dark:bg-neutral-800 rounded-xl border border-neutral-300 dark:border-neutral-700 shadow-sm hover:shadow-md transition-all duration-300">
            <div className={`border-b border-neutral-200 dark:border-neutral-700 ${isMobile ? 'px-4 py-4' : 'px-7 py-6'}`}>
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  <div className={`p-2 bg-orange-50 dark:bg-orange-900/20 rounded-lg border border-orange-100 dark:border-orange-800`}>
