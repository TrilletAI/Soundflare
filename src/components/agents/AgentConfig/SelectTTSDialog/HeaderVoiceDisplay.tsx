    ...
    <div className="flex items-start gap-3">
      <div className={`px-3 py-2 rounded-lg border ${
        normalizedProvider === 'sarvam' 
          ...
          ? 'bg-blue-50 dark:bg-orange-950/20 border-blue-200 dark:border-orange-800'
      ...
      <Button
        ...
        className={`${showSettings ? 'bg-blue-50 dark:bg-orange-950/20 border-blue-300 dark:border-orange-700' : ''}`}
      >
