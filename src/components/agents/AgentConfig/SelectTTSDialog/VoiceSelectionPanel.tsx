    ...
    <div
      ...
      className={`group cursor-pointer p-2 rounded-md border transition-all hover:shadow-sm ${
        isSelected 
          ...
          : 'border-neutral-200 dark:border-neutral-700 hover:border-orange-200 dark:hover:border-orange-700 hover:bg-orange-50/50 dark:hover:bg-orange-900/5'
      }`}
    >
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            <code className="text-xs bg-gray-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-gray-600 dark:text-gray-300">{voice.id}</code>
          </div>
          <div className="flex items-center gap-1.5 mt-0.5">
            <span className="text-xs px-1.5 py-0.5 bg-gray-100 dark:bg-neutral-800 rounded text-gray-600 dark:text-gray-300">
              {voice.style}
            </span>
    ...
    <div
      ...
      className={`group cursor-pointer p-2 rounded-md border transition-all hover:shadow-sm ${
        isSelected 
          ...
          : 'border-neutral-200 dark:border-neutral-700 hover:border-purple-200 dark:hover:border-purple-700 hover:bg-purple-50/50 dark:hover:bg-purple-900/5'
      }`}
    >
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            <h3 className="font-medium text-xs text-gray-900 dark:text-gray-100 truncate">{voice.name}</h3>
            {isSelected && <CheckCircle className="w-3 h-3 text-green-600 flex-shrink-0" />}
            <code className="text-xs bg-gray-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-gray-600 dark:text-gray-300">{voice.voice_id}</code>
          </div>
          <div className="flex items-center gap-1.5 mt-0.5">
            <span className="text-xs px-1.5 py-0.5 bg-gray-100 dark:bg-neutral-800 rounded text-gray-600 dark:text-gray-300">
...
const GoogleTTSVoiceCard = ({ 
  ...
  return (
    <div
      ...
      className={`group cursor-pointer p-2 rounded-md border transition-all hover:shadow-sm ${
        isSelected 
          ? 'border-blue-300 dark:border-orange-600 bg-blue-50 dark:bg-orange-900/10' 
          : 'border-neutral-200 dark:border-neutral-700 hover:border-blue-200 dark:hover:border-orange-700 hover:bg-blue-50/50 dark:hover:bg-orange-950/5'
      }`}
    >
      <div className="flex items-center gap-2">
        ...
        <div className="flex-1 min-w-0">
          <div className="flex items-center gap-2">
            ...
            {isSelected && <CheckCircle className="w-3 h-3 text-green-600 flex-shrink-0" />}
            <code className="text-xs bg-gray-100 dark:bg-neutral-800 px-1.5 py-0.5 rounded text-gray-600 dark:text-gray-300">{voice.name}</code>
          </div>
          <div className="flex items-center gap-1.5 mt-0.5">
            <span className="text-xs px-1.5 py-0.5 bg-gray-100 dark:bg-neutral-800 rounded text-gray-600 dark:text-gray-300">
              {voice.gender}
...
const VoiceSelectionPanel: React.FC<VoiceSelectionPanelProps> = ({
  ...
  }, [setElevenLabsVoices, setElevenLabsFetched])
  ...
  }, [elevenLabsFetched, fetchElevenLabsVoices])
  ...
  return (
    <div className={`${showSettings ? 'w-1/2' : 'w-full'} transition-all duration-300 ${showSettings ? 'border-r border-neutral-200 dark:border-neutral-800' : ''} flex flex-col`}>
