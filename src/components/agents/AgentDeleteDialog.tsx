...
const AgentDeleteDialog: React.FC<AgentDeleteDialogProps> = ({
  ...
  return (
    <Dialog open={agent !== null} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-800 rounded-xl">
        <DialogHeader>
        ...
        <div className="flex gap-3 pt-5">
          <Button 
            ...
            onClick={onClose}
            disabled={isDeleting}
            className="flex-1 border-neutral-300 dark:border-neutral-600 text-gray-700 dark:text-gray-300"
          >
            Cancel
          </Button>
          <Button
