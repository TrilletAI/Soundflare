    ...
    <div className="h-full flex flex-col bg-white dark:bg-neutral-800">
      ...
      {!voiceState.isConnected && !voiceState.isConnecting && (
        <div className="p-4 text-center flex-shrink-0">
          <div className="w-12 h-12 mx-auto mb-3 bg-orange-50 dark:bg-orange-900/30 rounded-full flex items-center justify-center">
      ...
      {voiceState.isConnected && (
        <>
          ...
          <div className="px-4 py-2 border-b border-neutral-200 dark:border-neutral-700 flex-shrink-0">
            ...
            <Collapsible open={showDetails} onOpenChange={setShowDetails}>
              <CollapsibleContent className="mt-3 space-y-3">
                ...
                {/* Connection Details */}
                <div className="p-2 bg-gray-50 dark:bg-neutral-900/50 rounded text-xs space-y-1">
          ...
          <div className="flex-1 flex flex-col min-h-0 p-4">
            ...
            <div className="flex-1 bg-gray-50 dark:bg-neutral-900/50 rounded-lg overflow-hidden">
                      ...
                      >
                        <div className="flex items-start gap-2 max-w-[85%]">
                          ...
                          <div
                            ...
                            } ${!transcript.isFinal ? 'opacity-60 border-2 border-dashed border-neutral-300' : ''}`}
                          >
                            <p className="break-words">{transcript.text}</p>
                            <div className="text-xs opacity-70 mt-1 flex items-center justify-between">
                              <span>{transcript.timestamp.toLocaleTimeString()}</span>
                              {!transcript.isFinal && (
                                <span className="ml-2 text-xs bg-gray-200 dark:bg-neutral-600 px-1 rounded">
                                  partial
                                </span>
                              )}
                            </div>
      ...
      {!voiceState.isConnected && !voiceState.isConnecting && (
        <div className="p-4 mt-auto flex-shrink-0">
          <div className="p-3 bg-orange-50 dark:bg-orange-900/20 rounded-lg">
            <h4 className="text-xs font-medium text-orange-700 dark:text-orange-300 mb-2">
              Voice Testing Tips
            </h4>
