...
const MagicButton = React.forwardRef(({ ...props }, ref) => {
  return (
    <Button
      ...
      variant="outline"
      className="group relative overflow-hidden border-2 border-neutral-200 dark:border-neutral-700 hover:border-purple-400 dark:hover:border-purple-400 transition-all duration-300 hover:shadow-lg hover:shadow-purple-400/25 bg-transparent"
    >
