              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-gray-900 flex items-center gap-2">
                    <span className="w-6 h-6 bg-orange-100 text-orange-700 rounded-full flex items-center justify-center text-sm font-semibold">1</span>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        disabled={loading}
                        className="h-11 px-4 text-sm border-neutral-300 rounded-lg focus:border-orange-500 focus:ring-2 focus:ring-orange-100 dark:focus:border-orange-500 dark:focus:ring-orange-500/20 transition-all"
                      />
                    </div>
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        placeholder="09:00"
                        step="300"
                        className="h-11 px-4 text-sm border-neutral-300 rounded-lg focus:border-orange-500 focus:ring-2 focus:ring-orange-100 dark:focus:border-orange-500 dark:focus:ring-orange-500/20 transition-all font-mono"
                      />
                    </div>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-gray-900 flex items-center gap-2">
                    <span className="w-6 h-6 bg-orange-100 text-orange-700 rounded-full flex items-center justify-center text-sm font-semibold">2</span>
                ...
                <div className="space-y-4">
                  <h3 className="text-lg font-medium text-gray-900 flex items-center gap-2">
                    <span className="w-6 h-6 bg-orange-100 text-orange-700 rounded-full flex items-center justify-center text-sm font-semibold">3</span>
                ...
                <div className="flex gap-3 pt-4">
                  <Button 
                    ...
                    onClick={handleClose}
                    disabled={loading}
                    className="flex-1 h-11 font-medium text-gray-700 border-neutral-300 hover:bg-gray-50 rounded-lg"
                  >
                    Cancel
                  </Button>
                  <Button 
            ...
            <div className="px-6 pb-6 space-y-4">
              ...
              {campaignResult?.campaign && (
                <div className="p-3 bg-orange-50 border border-orange-200 rounded-lg">
                  <h4 className="font-medium text-orange-900 text-sm mb-2 flex items-center gap-2">
                    <Rocket className="w-4 h-4" />
                    Campaign Details
                  </h4>
                  <div className="space-y-1 text-xs">
                    <div className="flex justify-between">
                      <span className="text-orange-700">Period:</span>
                    ...
                    <div className="flex justify-between">
                      <span className="text-orange-700">Calls:</span>
                      <span className="text-orange-900">{campaignResult.campaign.call_count} contacts</span>
                    </div>
                    <div className="flex justify-between">
                      <span className="text-orange-700">Concurrency:</span>
                      <span className="text-orange-900">{campaignResult.campaign.concurrency} simultaneous</span>
                    </div>
                  </div>
                </div>
              )}
