...
const ObservabilityStats: React.FC<ObservabilityStatsProps> = ({ sessionId, agentId, callData, agent }) => {
  ...
  const conversationMetrics: any = useMemo(() => {
    ...
    transcriptLogs.forEach((log: TranscriptLog) => {
      ...
      if (log.tts_metrics) {
        const llmTime = log.llm_metrics?.ttft || 0
        const ttsTime = (log.tts_metrics?.ttfb || 0) + (log.tts_metrics?.duration || 0)
        const totalTurnTime = llmTime + ttsTime
      ...
      if (
        ...
        const llmTime = log.llm_metrics.ttft || 0
        const ttsTime = (log.tts_metrics?.ttfb || 0) + (log.tts_metrics?.duration || 0)
        const endToEndTime = eouTime + llmTime + ttsTime
  ...
  if (transcriptLoading) {
    return (
      <div className="px-6 py-3 border-b border-neutral-200 dark:border-neutral-800 bg-gray-50 dark:bg-neutral-800">
        <div className="animate-pulse">
          <div className="flex items-center justify-between mb-3">
            <div className="h-4 bg-gray-200 dark:bg-neutral-600 rounded w-32"></div>
            <div className="h-3 bg-gray-200 dark:bg-neutral-600 rounded w-20"></div>
          </div>
          <div className="flex items-center justify-between">
            <div className="flex gap-6">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="flex items-center gap-2">
                  <div className="w-4 h-4 bg-gray-200 dark:bg-neutral-600 rounded"></div>
                  <div className="h-4 bg-gray-200 dark:bg-neutral-600 rounded w-12"></div>
                </div>
              ))}
            </div>
            <div className="flex gap-4">
              {[...Array(4)].map((_, i) => (
                <div key={i} className="text-center">
                  <div className="h-3 bg-gray-200 dark:bg-neutral-600 rounded w-8 mb-1"></div>
                  <div className="h-3 bg-gray-200 dark:bg-neutral-600 rounded w-6"></div>
                </div>
              ))}
            </div>
          </div>
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-8">
              ...
              <Tooltip>
                ...
                <TooltipContent side="bottom" className="bg-white dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700 text-gray-900 dark:text-gray-100">
            ...
            <div className="flex items-center gap-8 text-xs">
              ...
              <div className="flex items-center gap-6">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="bg-white dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700 text-gray-900 dark:text-gray-100">
                    <div className="text-xs">
              ...
              {/* Reference Metrics Group - STT */}
              <div className="flex items-center gap-2 px-3 py-1.5 rounded-md bg-gray-50 dark:bg-neutral-700 border border-dashed border-neutral-300 dark:border-neutral-600">
                ...
                <Tooltip>
                  ...
                  <TooltipContent className="bg-white dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700 text-gray-900 dark:text-gray-100">
                    <div className="text-xs">
                      ...
                      <div className="text-orange-600 dark:text-orange-400 text-xs font-medium mt-1 pt-1 border-t border-neutral-200 dark:border-neutral-600">
