...
const RawDataView = ({ span }: { span: any }) => {
  ...
  const renderFormattedData = () => {
    ...
    const categoryLabels = {
      identifiers: { title: 'Identifiers', icon: <Hash className="w-4 h-4" />, color: 'bg-blue-50 dark:bg-orange-900/20 border-blue-200 dark:border-orange-800' },
      ...
      status: { title: 'Status', icon: <CheckCircle2 className="w-4 h-4" />, color: 'bg-gray-50 dark:bg-neutral-800 border-neutral-200 dark:border-neutral-700' },
    ...
    const renderField = ([key, value]: [string, any]) => {
      ...
      return (
        <div key={key} className="group bg-white dark:bg-neutral-900 rounded-lg p-3 border border-slate-200 dark:border-slate-700 hover:border-slate-300 dark:hover:border-slate-600 transition-colors">
    ...
    <div className="flex flex-col h-full">
          ...
          <div className="flex items-center bg-slate-100 dark:bg-slate-800 rounded-lg p-1">
            <button
              ...
              className={`flex items-center gap-2 px-3 py-1.5 text-xs font-medium rounded-md transition-all ${
                viewMode === 'formatted'
                  ? 'bg-white dark:bg-neutral-900 text-slate-900 dark:text-slate-100 shadow-sm'
      ...
      <div className="flex-1 overflow-auto">
        {viewMode === 'formatted' ? (
          ...
          <div className="bg-slate-900 dark:bg-neutral-950 rounded-lg p-4 min-h-full">
...
const SpanDetailSheet = ({ span, isOpen, onClose }: SpanDetailSheetProps) => {
  ...
  const { data: fullSpanData } = useSupabaseQuery("soundflare_spans", {
  ...
  const getSpanIcon = () => {
    ...
    if (operationType === 'stt') return <Mic className="w-5 h-5 text-blue-600 dark:text-orange-400" />;
    if (operationType === 'user_interaction') return <User className="w-5 h-5 text-purple-600 dark:text-purple-400" />;
    if (operationType === 'assistant_interaction') return <Bot className="w-5 h-5 text-blue-600 dark:text-orange-400" />;
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-[600px] bg-white dark:bg-neutral-900 shadow-2xl border-l border-neutral-200 dark:border-neutral-700 z-50 flex flex-col">
      {/* Header */}
      ...
      {/* Tab Navigation */}
      <div className="border-b border-neutral-200 dark:border-neutral-700 bg-gray-50 dark:bg-neutral-800">
        <div className="flex">
          {[
            ...
            <button
              ...
              className={`flex items-center gap-2 px-6 py-3 text-sm font-medium border-b-2 transition-colors ${
                activeTab === tab.key
                  ? 'border-blue-600 dark:border-orange-500 text-blue-600 dark:text-orange-400 bg-white dark:bg-neutral-900'
                  : 'border-transparent text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-neutral-700'
              }`}
            >
              {tab.icon}
              {tab.label}
      ...
      <div className="flex-1 overflow-y-auto p-6 bg-white dark:bg-neutral-900">
        {activeTab === 'overview' && (
          <div className="space-y-6">
            {/* What Happened */}
            <div className="bg-blue-50 dark:bg-orange-900/20 rounded-xl p-4 border border-blue-200 dark:border-orange-800">
              <h3 className="font-semibold mb-3 flex items-center gap-2 text-blue-800 dark:text-orange-300">
                <MessageSquare className="w-4 h-4" />
                What Happened
              </h3>
              <p className="text-blue-900 dark:text-orange-200 text-sm leading-relaxed">
                {getSpanDescription()}
              </p>
            </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 border border-neutral-200 dark:border-neutral-700">
                ...
                <div className="flex items-center gap-2">
                  {displaySpan.request_id ? (
                    <>
                      <code className="bg-white dark:bg-neutral-900 px-2 py-1 rounded text-xs font-mono border border-neutral-200 dark:border-neutral-600">
                        {displaySpan.request_id}
                      </code>
                      <Button
                        variant="ghost"
          ...
          <div className="space-y-6">
            <div className="grid grid-cols-1 gap-4">
              <div className="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 border border-neutral-200 dark:border-neutral-700">
                ...
                <code className="bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-600 rounded p-2 text-sm font-mono block text-gray-900 dark:text-gray-100">
              ...
              <div className="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 border border-neutral-200 dark:border-neutral-700">
                ...
                <Badge variant="outline" className="text-sm border-neutral-300 dark:border-neutral-600 text-gray-700 dark:text-gray-300 bg-white dark:bg-neutral-800">
              ...
              <div className="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4 border border-neutral-200 dark:border-neutral-700">
                ...
                <div className="space-y-2 text-sm">
                  <div className="flex justify-between">
                    ...
                    {displaySpan.request_id ? (
                      <code className="bg-white dark:bg-neutral-900 px-2 py-1 rounded text-xs border border-neutral-200 dark:border-neutral-600">
                        {displaySpan.request_id}
                      </code>
                    ) : (
