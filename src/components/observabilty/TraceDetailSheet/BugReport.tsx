  ...
  const isFlaggedTurn =
    ...
    <div className="space-y-6">
        ...
        <div className="p-6 space-y-4">
            ...
            <div className="border-l-4 border-blue-200 dark:border-orange-700 pl-4">
                <div className="flex items-center gap-2 mb-2">
                <User className="w-4 h-4 text-blue-600 dark:text-orange-400" />
    ...
    {currentTurnBugReports.length > 0 && (
        ...
        {currentTurnBugReports.map((report: any, index: number) => {
            ...
            <div key={`${report.timestamp}-${index}`} className="space-y-4">
                {/* Initial Bug Report */}
                {initialReport && (
                <div className="bg-white dark:bg-neutral-800 rounded-xl border border-amber-200 dark:border-amber-800 overflow-hidden shadow-sm">
                ...
                <div className="bg-white dark:bg-neutral-800 rounded-xl border border-blue-200 dark:border-orange-800 overflow-hidden shadow-sm">
                    <div className="px-6 py-4 border-b border-blue-100 dark:border-orange-700 bg-blue-50 dark:bg-orange-900/20">
                    <div className="flex items-center gap-3">
                        <div className="w-7 h-7 rounded-full bg-blue-100 dark:bg-orange-800 text-blue-700 dark:text-orange-300 flex items-center justify-center text-sm font-semibold">
                        💬
                        </div>
                        <div className="flex items-center gap-2">
                    ...
                    <div className="space-y-3">
                        ...
                        <div key={`${report.timestamp}-detail-${detailIndex}`} className="relative">
                            <div className="absolute left-0 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-200 dark:from-orange-200 to-blue-100 dark:to-orange-100 rounded-full"></div>
                            <div className="pl-6">
                            <blockquote className="text-gray-900 dark:text-gray-100 leading-relaxed">
    ...
    {currentFlaggedTurn && (
        ...
        <div className="grid grid-cols-1 gap-3">
            ...
            <code className="text-sm bg-gray-100 dark:bg-neutral-800 text-gray-800 dark:text-gray-200 px-2 py-1 rounded">{currentFlaggedTurn.turn_id}</code>
            </div>
            <div className="flex justify-between items-center p-3 bg-white dark:bg-neutral-900 border border-neutral-200 dark:border-neutral-600 rounded">
    ...
    {/* Debug Information */}
    <details className="bg-gray-50 dark:bg-neutral-800 rounded-lg p-4">
        ...
        <pre className="bg-white dark:bg-neutral-900 text-gray-800 dark:text-gray-200 p-3 rounded border border-neutral-200 dark:border-neutral-700 overflow-auto max-h-64">
            {JSON.stringify(
            {
