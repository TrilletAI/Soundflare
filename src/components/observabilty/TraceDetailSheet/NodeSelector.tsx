          ...
          <button
            ...
            className={cn(
              ...
              selectedNode === stage.id
                ? "border-blue-500 dark:border-orange-400 bg-blue-50 dark:bg-orange-900/20 shadow-sm"
                ...
                <div className="font-medium text-sm flex items-center gap-2 text-gray-900 dark:text-gray-100">
                  ...
                  {stage.tools && stage.tools.length > 0 && (
                    <div className="flex items-center gap-1">
                      ...
                      <span className="text-xs text-blue-600 dark:text-orange-400 font-medium">{stage.tools.length}</span>
                    </div>
                  )}
