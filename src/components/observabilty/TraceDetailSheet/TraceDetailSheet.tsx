...
const EnhancedTraceDetailSheet: React.FC<TraceDetailSheetProps> = ({ 
  ...
  }, [trace, recordingUrl, callStartTime])
  ...
  const llmRequests = useMemo(() => trace?.enhanced_data?.llm_requests || [], [trace?.enhanced_data?.llm_requests])
  ...
  ].filter(stage => stage.active)}, [trace, vadConfig, eouConfig, sttConfig, llmConfig, ttsConfig, enhancedSTT, enhancedLLM, enhancedTTS, llmRequests])
  ...
  return (
    <TooltipProvider>
      <Sheet open={isOpen} onOpenChange={onClose}>
        ...
        >
          {/* Header */}
          <SheetHeader className="border-b border-neutral-200 dark:border-neutral-800 px-6 py-4">
            <div className="flex items-center gap-3">
              <div className="w-8 h-8 rounded-lg bg-blue-100 dark:bg-orange-900/20 flex items-center justify-center">
                <Activity className="w-4 h-4 text-blue-600 dark:text-orange-400" />
              </div>
              <div>
                      ...
                      className={cn(
                        ...
                        selectedView === tab.id
                          ? tab.id === "bug-report"
                            ...
                            : "border-blue-500 dark:border-orange-400 text-blue-600 dark:text-orange-400" 
          ...
          <div className="flex-1 overflow-hidden">
            {selectedView === "pipeline" && (
              <div className="flex h-full">
                ...
                <div className="w-80 border-r border-neutral-200 dark:border-neutral-800 bg-gray-50 dark:bg-neutral-800 p-4 flex-shrink-0">
            ...
            {selectedView === "config" && (
              <div className="p-6 h-full overflow-y-auto">
                <div className="space-y-4">
                  ...
                  <pre className="bg-gray-50 dark:bg-neutral-800 text-gray-800 dark:text-gray-200 p-4 rounded text-xs overflow-auto max-h-[70vh] border border-neutral-200 dark:border-neutral-700">
            ...
            {selectedView === "insights" && (
              <div className="p-6 h-full overflow-y-auto">
                <EnhancedInsights trace={trace} pipelineStages={pipelineStages} setCopiedField={setCopiedField} copiedField={copiedField} />
              </div>
            )}
