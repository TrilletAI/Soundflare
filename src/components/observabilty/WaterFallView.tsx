...
const WaterfallView = ({ trace, loading }: WaterfallViewProps) => {
  ...
  const getOperationIcon = (opType: string) => {
    switch (opType) {
      ...
      case 'stt': return <Mic className="w-4 h-4 text-orange-600 dark:text-orange-400" />;
      case 'user_interaction': return <User className="w-4 h-4 text-orange-500 dark:text-orange-300" />;
  ...
  const getSpanColor = (opType: string) => {
    switch (opType) {
      ...
      case 'stt': return 'bg-orange-500 dark:bg-orange-600';
      case 'user_interaction': return 'bg-orange-400 dark:bg-orange-500';
  ...
  return (
    <>
      <div className="flex-1 overflow-y-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-slate-50 to-gray-50 dark:from-neutral-800 dark:to-neutral-800 px-6 py-4 border-b border-neutral-200 dark:border-neutral-700">
          ...
          <div className="grid grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-lg font-bold text-orange-600 dark:text-orange-400">{totalSpans}</div>
        ...
        <div className="divide-y divide-gray-100 dark:divide-gray-800">
          {traceGroups.map((traceGroup) => (
            <div key={traceGroup.trace_id}>
              {/* Trace Header */}
              <div 
                className="px-6 py-3 hover:bg-gray-50 dark:hover:bg-neutral-800 cursor-pointer flex items-center justify-between group"
              ...
              >
                ...
                <div className="flex items-center gap-4 text-xs text-gray-500 dark:text-gray-400">
                  ...
                  <span className="px-2 py-1 bg-gray-100 dark:bg-neutral-700 text-gray-700 dark:text-gray-300 rounded">
                      ...
                      {traceGroup.spans.map((span, index) => {
                        ...
                        return (
                          <div 
                            ...
                            className="flex items-center h-8 hover:bg-white dark:hover:bg-neutral-700 cursor-pointer rounded group"
                            onClick={(e) => {
                              e.stopPropagation();
                          ...
                          >
                            ...
                            <div className="flex-1 relative h-6 bg-gray-200 dark:bg-neutral-600 rounded">
                              {/* Span bar */}
                              <div
                            ...
                            <div className="w-32 text-right text-xs text-gray-500 dark:text-gray-400 pl-4">
                              ...
                              <div className="text-[10px] uppercase font-medium px-1 py-0.5 bg-gray-200 dark:bg-neutral-700 text-gray-700 dark:text-gray-300 rounded mt-0.5 inline-block">
                                {span.operation_type}
                              </div>
                            </div>
                          </div>
        ...
        {/* Summary */}
        <div className="mt-8 px-6 py-4 bg-gray-50/50 dark:bg-neutral-800/50 border-t border-neutral-200 dark:border-neutral-700">
