...
const ProjectSelection: React.FC<ProjectSelectionProps> = ({ isAuthLoaded = false}) => {
  ...
  const getEnvironmentColor = (environment: string) => {
    switch (environment.toLowerCase()) {
      ...
      default:
        return 'bg-gray-50 text-gray-700 border-neutral-200 dark:bg-neutral-800 dark:text-gray-300 dark:border-neutral-700'
    }
  }
  ...
  const ComfortableCard = ({ project }: { project: Project }) => (
    <Card
      className={`group bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700 hover:border-neutral-300 dark:hover:border-neutral-600 hover:shadow-md dark:hover:shadow-lg transition-all duration-200 cursor-pointer ${
      ...
      <CardContent className="p-4">
        ...
        <div className="flex items-start justify-between mb-3">
          <div className="flex items-center gap-3 min-w-0 flex-1">
            <div className="w-8 h-8 bg-gradient-to-br from-indigo-500 to-orange-600 rounded flex items-center justify-center text-white font-medium text-xs flex-shrink-0">
            ...
            <div className="min-w-0 flex-1">
              <div className="flex items-center gap-2 mb-1">
                ...
                <div className={`w-1.5 h-1.5 rounded-full flex-shrink-0 ${project.is_active ? 'bg-emerald-500' : 'bg-gray-300 dark:bg-neutral-600'}`}></div>
              </div>
              <div className="flex items-center gap-1">
                ...
                {project.agent_count !== undefined && (
                  <Badge variant="outline" className="text-xs font-normal bg-orange-50 dark:bg-orange-900/20 text-orange-700 dark:text-orange-300 border-orange-200 dark:border-orange-800 px-1.5 py-0">
                    {project.agent_count}
                  </Badge>
                )}
              </div>
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button
                variant="ghost"
                size="sm"
                className="opacity-0 group-hover:opacity-100 transition-opacity h-6 w-6 p-0 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-neutral-700"
        ...
        <div className="flex items-center justify-between pt-3 border-t border-neutral-100 dark:border-neutral-700">
          ...
          <div className="flex items-center gap-1 text-xs text-gray-400 dark:text-gray-500 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">
            <span>Open</span>
      ...
      <CardContent className="p-3">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2.5 min-w-0 flex-1">
            <div className="w-7 h-7 bg-gradient-to-br from-indigo-500 to-orange-600 rounded flex items-center justify-center text-white font-medium text-xs flex-shrink-0">
              {getOrganisationInitials(project.name)}
            </div>
            <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-1">
            ...
            <ChevronRight className="w-3 h-3 text-gray-400 dark:text-gray-500 opacity-0 group-hover:opacity-100 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-all" />
          </div>
        </div>
      </CardContent>
    </Card>
        ...
        <div className="max-w-7xl mx-auto px-6 py-6 w-full flex-shrink-0">
          ...
          <div className="mb-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                <div className="flex items-center gap-2 mb-2">
                  <div className="h-6 w-24 bg-gray-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                </div>
                <div className="h-3 w-80 bg-gray-200 dark:bg-neutral-700 rounded animate-pulse"></div>
              </div>
              <div className="h-8 w-28 bg-gray-200 dark:bg-neutral-700 rounded animate-pulse"></div>
            </div>
            ...
            <div className="flex items-center justify-between">
              ...
              <div className="h-7 w-16 bg-gray-200 dark:bg-neutral-700 rounded animate-pulse"></div>
            </div>
          </div>
        </div>
          ...
          <div className="max-w-7xl mx-auto px-6 pb-6">
            ...
            <div className="grid gap-3 grid-cols-1 lg:grid-cols-2 xl:grid-cols-3">
              {Array.from({ length: 6 }).map((_, index) => (
                <Card key={index} className="bg-white dark:bg-neutral-800 border border-neutral-200 dark:border-neutral-700">
                  <CardContent className="p-4">
                    {/* Header Skeleton */}
                    <div className="flex items-start justify-between mb-3">
                      <div className="flex items-center gap-3 min-w-0 flex-1">
                        <div className="w-8 h-8 bg-gray-200 dark:bg-neutral-700 rounded animate-pulse flex-shrink-0"></div>
                        <div className="min-w-0 flex-1">
                          <div className="flex items-center gap-2 mb-1">
                            <div className="h-4 w-24 bg-gray-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                            <div className="w-1.5 h-1.5 bg-gray-200 dark:bg-neutral-700 rounded-full animate-pulse"></div>
                          </div>
                          <div className="flex items-center gap-1">
                            <div className="h-4 w-12 bg-gray-200 dark:bg-neutral-700 rounded-full animate-pulse"></div>
                            <div className="h-4 w-8 bg-gray-200 dark:bg-neutral-700 rounded-full animate-pulse"></div>
                          </div>
                        </div>
                      </div>
                      <div className="w-6 h-6 bg-gray-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                    </div>

                    {/* Description Skeleton */}
                    <div className="space-y-1 mb-4">
                      <div className="h-3 w-full bg-gray-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                      <div className="h-3 w-2/3 bg-gray-200 dark:bg-neutral-700 rounded animate-pulse"></div>
                    </div>
        ...
        <div className="flex-1 flex items-center justify-center">
          <div className="text-center space-y-4 max-w-sm">
            ...
            <Button 
              ...
              size="sm"
              className="bg-orange-600 hover:bg-orange-700 text-white text-xs px-3 py-1.5 h-7"
            >
              Try again
            </Button>
          </div>
          ...
          <div className="flex items-center justify-between mb-4">
            <div>
              <div className="flex items-center gap-2 mb-1">
                ...
                <Badge variant="outline" className="text-xs text-gray-600 dark:text-gray-400 border-neutral-200 dark:border-neutral-700">
                  {projects.length}
                </Badge>
              </div>
            ...
            <Button 
              ...
              size="sm"
              className={`bg-orange-600 hover:bg-orange-700 text-white font-medium text-xs h-8 ${isMobile ? 'px-3 py-0' : 'px-3 py-1.5'}`}
            >
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              <div className="relative">
                ...
                <input
                  ...
                  className={`${isMobile ? 'w-full' : 'w-64'} pl-7 pr-3 py-1.5 text-xs border border-neutral-200 dark:border-neutral-700 rounded bg-gray-50 dark:bg-neutral-800 text-gray-900 dark:text-gray-100 placeholder:text-gray-500 dark:placeholder:text-gray-400 focus:border-orange-500 dark:focus:border-orange-500 focus:ring-1 focus:ring-orange-500/20 dark:focus:ring-orange-500/20 focus:outline-none transition-all focus:bg-white dark:focus:bg-neutral-700`}
                />
              </div>
            </div>
            ...
            <div className="flex items-center gap-3">
              ...
              {viewMode === 'grid' && <button
                ...
                className="flex items-center justify-center w-7 h-7 border border-neutral-200 dark:border-neutral-700 rounded bg-gray-50 dark:bg-neutral-800 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-neutral-700 transition-colors"
              >
                <ChevronsUpDown className="w-3 h-3" />
              </button>}

              {/* View Mode Control */}
              <div className="flex items-center border border-neutral-200 dark:border-neutral-700 rounded p-0.5 bg-gray-50 dark:bg-neutral-800">
                <Button
                  variant={viewMode === 'grid' ? 'default' : 'ghost'}
                  size="sm"
                  onClick={() => setViewMode('grid')}
                  className={`w-6 h-6 p-0 text-xs ${viewMode === 'grid' ? 'bg-white dark:bg-neutral-700 shadow-sm text-gray-900 dark:text-gray-100 hover:bg-white dark:hover:bg-neutral-700' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-transparent'}`}
                >
                ...
                <Button
                  ...
                  className={`w-6 h-6 p-0 text-xs ${viewMode === 'list' ? 'bg-white dark:bg-neutral-700 shadow-sm text-gray-900 dark:text-gray-100 hover:bg-white dark:hover:bg-neutral-700' : 'text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 hover:bg-transparent'}`}
                >
        ...
        <div className="max-w-7xl mx-auto px-6 pb-6">
          ...
          {viewMode === 'list' ? (
            ...
            <div className="border border-neutral-200 dark:border-neutral-700 rounded-lg overflow-hidden bg-white dark:bg-neutral-800">
              {/* Table Header */}
              <div className="px-6 py-3 bg-gray-50 dark:bg-neutral-800/50 border-b border-neutral-200 dark:border-neutral-700">
              ...
              <div>
                {filteredProjects.map((project, index) => (
                  <div
                    key={project.id}
                    className={`group px-6 py-4 hover:bg-gray-50 dark:hover:bg-neutral-700/50 transition-colors cursor-pointer ${
                      index !== filteredProjects.length - 1 ? 'border-b border-neutral-200 dark:border-neutral-700' : ''
                        ...
                        <DropdownMenu>
                          <DropdownMenuTrigger asChild>
                            <Button
                              variant="ghost"
                              size="sm"
                              className="opacity-0 group-hover:opacity-100 transition-opacity h-7 w-7 p-0 text-gray-400 dark:text-gray-500 hover:text-gray-600 dark:hover:text-gray-300 hover:bg-gray-100 dark:hover:bg-neutral-700"
                              onClick={(e) => e.stopPropagation()}
                            >
                              <MoreHorizontal className="h-3 w-3" />
                            </Button>
          ...
          {filteredProjects.length === 0 && searchQuery && (
            <div className="text-center py-16">
              ...
              <Button 
                ...
                className="text-gray-600 dark:text-gray-400 border-neutral-300 dark:border-neutral-600 text-xs h-7 hover:bg-gray-50 dark:hover:bg-gray-800"
              >
                Clear search
              </Button>
            </div>
        ...
        <DialogContent className="sm:max-w-[500px]">
          ...
          <div className="space-y-3">
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  readOnly
                  className="w-full h-8 px-2 pr-16 text-xs border border-neutral-200 dark:border-neutral-700 rounded bg-gray-50 dark:bg-neutral-800 text-gray-900 dark:text-gray-100 font-mono focus:outline-none"
                />
            ...
            <div className="flex justify-end pt-3">
              <Button onClick={handleCloseTokenDialog} size="sm" className="bg-orange-600 hover:bg-orange-700 text-white text-xs">
                Done
              </Button>
            </div>
          </div>
