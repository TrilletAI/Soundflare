            ...
            return (
              <div
                ...
                className={cn(
                  ...
                  isVisible
                    ? "bg-gray-100 dark:bg-neutral-800 border border-neutral-300 dark:border-neutral-700"
                    : "hover:bg-muted/50"
                )}
              >
                <Checkbox
                  ...
                  className="data-[state=checked]:bg-gray-700 data-[state=checked]:border-neutral-700 dark:data-[state=checked]:bg-gray-400 dark:data-[state=checked]:border-neutral-400"
                />
                <label
                  htmlFor={`${type}-${column}`}
                ...
                {isVisible && <div className="w-2 h-2 bg-gray-500 rounded-full opacity-60" />}
              </div>
            )
          })}
        </div>
